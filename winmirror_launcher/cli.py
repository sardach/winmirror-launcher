...
def main(argv=None):
    ...
    if open_panel:
        ...
        SimpleLauncherPanel(
            ...
            clock_font_color=simple_state.get("clock_font_color", "#e6ebf0"),
            clock_show_weather=simple_state.get("clock_show_weather", False),
            clock_show_precipitation=simple_state.get("clock_show_precipitation", False),
            clock_weather_location=simple_state.get("clock_weather_location", ""),
            background_color=simple_state.get("background_color", "#000000"),
            background_alpha=simple_state.get("background_alpha", 0.0),
